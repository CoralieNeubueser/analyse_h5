...
hist_tot = r.TH1D('hist_en_tot', 'hist_en_tot', 1000000,0,1000)
if filename.find('rate'):
      hist_tot = r.TH1D('hist_en_tot', 'hist_en_tot', 1000,0,1000)
inRoot.tree.Draw('flux>>hist_en_tot','field>25000&&flux!=0','')
if filename.find('rate'):
...
hist_tot_log = r.TH1D('hist_en_tot_log', 'hist_en_tot_log', 1000,-3,3)
inRoot.tree.Draw('log10(flux)>>hist_en_tot_log','field>25000&&flux!=0','')
if filename.find('rate'):
...
for e in range(energyBins):
      ...
      histList1D_ln.append( r.TH1D('hist_en_log10_'+str(energies[e])+'MeV', 'hist_en_log10_'+str(energies[e])+'MeV', 10000,-3,3) )
      histList1D_rate.append( r.TH1D('hist_en_rate_'+str(energies[e])+'MeV', 'hist_en_rate_'+str(energies[e])+'MeV', 1000000,0,1000) )

      r.gROOT.SetBatch(True)
      inRoot.tree.Draw('flux_en['+str(e)+']>>hist_en_'+str(energies[e])+'MeV','field>25000&&flux_en['+str(e)+']!=0','')
      inRoot.tree.Draw('log10(flux_en['+str(e)+'])>>hist_en_log10_'+str(energies[e])+'MeV','field>25000&&flux_en['+str(e)+']!=0','')
      inRoot.tree.Draw('flux_en['+str(e)+']*'+str(ele_GF[e])+'>>hist_en_rate_'+str(energies[e])+'MeV','field>25000&&flux_en['+str(e)+']!=0','')
...
inRoot.tree.Draw('pitch:L:flux>>hist2D_l_pitch_noSAA('+str(l_bins)+',1,5,9,10,190)', 'field>25000','colz')
hist2D_l_pitch_noSAA = r.gDirectory.Get("hist2D_l_pitch_noSAA")
inRoot.tree.Draw('pitch:L:pow(flux,2)>>hist2D_l_pitch_rms_noSAA('+str(l_bins)+',1,5,9,10,190)', 'field>25000','colz')
hist2D_l_pitch_rms_noSAA = r.gDirectory.Get("hist2D_l_pitch_rms_noSAA")
inRoot.tree.Draw('pitch:energy:flux.flux>>hist2D_energy_pitch_noSAA('+str(energyBins)+',0,'+str(energyMax)+',9,10,190)', 'field>25000','colz')
hist2D_energy_pitch_noSAA = r.gDirectory.Get("hist2D_energy_pitch_noSAA")
inRoot.tree.Draw('pitch:energy:pow(flux.flux,2)>>hist2D_energy_pitch_rms_noSAA('+str(energyBins)+',0,'+str(energyMax)+',9,10,190)', 'field>25000','colz')
hist2D_energy_pitch_rms_noSAA =  r.gDirectory.Get("hist2D_energy_pitch_rms_noSAA")
inRoot.tree.Draw('L:field:flux.flux>>hist2D_B_l_noSAA(100,17000,55000,'+str(l_bins)+',1,5)', 'field>25000','colz')
hist2D_B_l_noSAA=r.gDirectory.Get("hist2D_B_l_noSAA")
inRoot.tree.Draw('L:field:pow(flux.flux,2)>>hist2D_B_l_rms_noSAA(100,17000,55000,'+str(l_bins)+',1,5)', 'field>25000','colz')
hist2D_B_l_rms_noSAA=r.gDirectory.Get("hist2D_B_l_rms_noSAA")

#inRoot.tree.Draw('pitch:L:flux.flux_en>>hist2D_l_pitch_flux('+str(l_bins)+',1,5,9,10,190)','','colz')
...
print ("hist entries: ", hist2D_l_pitch_rms_noSAA.GetEntries())
